        ...
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (isset($_POST["jenis"])) {
                    $jenis = $_POST["jenis"];
                    if ($jenis == "kendaraan") {
                        echo '<form action ="../php/simpan_kendaraan.php" method="POST" enctype="multipart/form-data" class="form-container">';
                    } elseif ($jenis == "senjata") {
                        echo '<form action ="../php/simpan_senjata.php" method="POST" enctype="multipart/form-data" class="form-container">';
                    } else {
